...
class SecurityConfigTest {
    ...
    void userDetailsService_shouldUseTrainerService() {
        ...
        TrainerWithPokemons trainerWithPokemons = new TrainerWithPokemons();

        var trainer = new Trainer();
        trainer.setName("Garry");
        trainer.setPassword("secret");

        trainerWithPokemons.setTrainer(trainer);
        when(trainerService.getTrainer("Garry")).thenReturn(trainerWithPokemons);
